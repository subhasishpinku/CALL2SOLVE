...
//        setContentView(R.layout.payubiz_activity);
...
//                    Toast.makeText(PayuBizActivity.this, getString(R.string.use_live_key_in_production_environment), Toast.LENGTH_SHORT).show();
//
...
//                    ((EditText) findViewById(R.id.editTextMerchantKey)).setText("CM60Sb");
//
...
//        mPaymentParams.setFirstName("prasenjit");
//        mPaymentParams.setEmail("prasenjit@diligenttech.in");
//        mPaymentParams.setPhone("9163752468");
//
//
//        /*
