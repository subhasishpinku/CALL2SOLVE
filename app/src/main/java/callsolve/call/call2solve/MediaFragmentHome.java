...
public class MediaFragmentHome extends Fragment implements OnBackClickListener{
    private String postUrl = "https://call2solv.com/cal2solv/Page/view_media_dtl1";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.media_web_view, container, false);
//        WebView mywebview = (WebView)rootView.findViewById(R.id.webView);
//        mywebview.loadUrl("http://gskt.in/cal2solv/Page/view_media_dtl1");
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (Utils.isSameDomain(postUrl, url)) {
                    Intent intent = new Intent(getContext(), MediaFragment.class);
