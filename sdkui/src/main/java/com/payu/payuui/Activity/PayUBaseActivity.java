   ...
   // private  boolean isPaymentByPhonePe = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            // bookingiD = bundle.getParcelable(PayuConstants.TXNID);
            Log.e("TextID",bookingiD);
         // Call back method of PayU custom browser to check availability of Samsung Pay
            ...
            ((TextView) findViewById(R.id.textview_txnid)).setText(SdkUIConstants.TXN_ID + ": " + bookingiD);
