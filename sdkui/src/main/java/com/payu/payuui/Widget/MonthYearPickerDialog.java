...
//                    }
//                });
        ((Button)dialog.findViewById(R.id.yId)).setOnClickListener(new View.OnClickListener(){
        ...
        ((Button)dialog.findViewById(R.id.nId)).setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                MonthYearPickerDialog.this.getDialog().cancel();
